...
Route::get('/product-category/{id}',[MyCommerceController::class,'category'])->name('category');
Route::get('/product-detail/{id}',[MyCommerceController::class,'detail'])->name('detail');
